...
export function AboutSection() {
  ...
  return (
    <section id="about" className="scroll-section py-20 px-4 md:px-8 lg:px-16">
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-extrabold mb-6 tracking-tight">
            <span className="neon-text animate-glow">Multi-Domain</span> Excellence
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {domains.map((domain, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass-card group hover:shadow-glow transition-all duration-300 flex flex-col h-full"
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className={`text-xl font-bold ${domain.color} tracking-wide`}>
                  {domain.title}
                </h3>
              </div>
              <p className="text-muted-foreground leading-relaxed text-base md:text-lg flex-1">
                {domain.description}
              </p>
            </motion.div>
          ))}
        ...
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="text-3xl md:text-4xl font-extrabold neon-text mb-2 animate-glow">
                {stat.number}
              </div>
